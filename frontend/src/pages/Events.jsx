...
const Events = () => {
  ...
  const renderEmptyView = () => {
    return (
      <h1 className="text-3xl text-black dark:text-white text-center font-semibold">
        Events Empty
      </h1>
    );
  };
        ...
        "
            ...
            <>
              {events?.length === 0 ? (
                ...
                <>
                  <h2 className="text-xl font-semibold text-center text-gray-700 dark:text-gray-200 mb-8">
                    All Events
                  </h2>
                  <ul className="grid grid-cols-1 md:grid-cols-2 place-content-center lg:grid-cols-3 gap-6">
                    {events?.map((event) => (
                      ...
                      >
                        ...
                        <p className=" text-sm text-gray-600 dark:text-gray-300 max-w-xs overflow-hidden overflow-ellipsis whitespace-nowrap">
                          {event.description}
                        </p>
                      </li>
                    ))}
